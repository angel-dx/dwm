...
static const char sel_bg[] = "#4a4a4a";
static const char sel_border[] = "#2a2a2a";

static const char *colors[][3] = {
    // set the border as bg for no borders
    /*               fg           bg          border                         */
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_Print, spawn,
     SHCMD("scrot -s -e 'xclip -selection clipboard -t image/png -i $f'")},
    {MODKEY | ControlMask, XK_Print, spawn,
     SHCMD("scrot -u -e 'xclip -selection clipboard -t image/png -i $f'")},
    {MODKEY | ShiftMask | ControlMask, XK_Print, spawn,
     SHCMD("scrot -cd 3 -e 'xclip -selection clipboard -t image/png -i $f'")},
